...
void ControllerState::sync_report() {
    ...
    bool up = dpad_up_ || keypad_dpad_up_;
    bool down = dpad_down_ || keypad_dpad_down_;
    bool left = dpad_left_ || keypad_dpad_left_;
    bool right = dpad_right_ || keypad_dpad_right_;
    ...
    uint16_t merged_buttons = buttons_ | keypad_buttons_;
