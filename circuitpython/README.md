...
| [`2026-08-30-switch-controller-test`](file:///home/omakoto/cbin/src/raspberry-pi-pico/circuitpython/2026-08-30-switch-controller-test) | Emulates a Nintendo Switch USB controller in composite device mode, mapping pins 0–5 to A, D-pad directions, and L+R buttons ([`switch-controller-test.py`](file:///home/omakoto/cbin/src/raspberry-pi-pico/circuitpython/2026-08-30-switch-controller-test/switch-controller-test.py)). |
| [`2026-08-30-tcp-test`](file:///home/omakoto/cbin/src/raspberry-pi-pico/circuitpython/2026-08-30-tcp-test) | TCP test server loading Wi-Fi and port config from `config.toml`, advertising IP via mDNS hostname, and logging incoming TCP traffic ([`tcp-test.py`](file:///home/omakoto/cbin/src/raspberry-pi-pico/circuitpython/2026-08-30-tcp-test/tcp-test.py)). |
| [`2026-08-30-i2ckeypad-test`](file:///home/omakoto/cbin/src/raspberry-pi-pico/circuitpython/2026-08-30-i2ckeypad-test) | PCF8574 I2C matrix keypad driver and tester ([`i2ckeypad-test.py`](file:///home/omakoto/cbin/src/raspberry-pi-pico/circuitpython/2026-08-30-i2ckeypad-test/i2ckeypad-test.py)), porting Rob Tillaart's I2CKeyPad library with support for 4x4, 5x3, 6x2, and 8x1 layouts, debouncing, and custom keymaps. |
| [`2026-09-04-w5500-lan-test`](file:///home/omakoto/cbin/src/raspberry-pi-pico/circuitpython/2026-09-04-w5500-lan-test) | TCP echo server over wired Ethernet using USR-ES1 (W5500) module, loading port and hostname from `config.toml`, acquiring DHCP lease, and echoing received data back to clients ([`w5500-lan-test.py`](file:///home/omakoto/cbin/src/raspberry-pi-pico/circuitpython/2026-09-04-w5500-lan-test/w5500-lan-test.py)). |
| [`nsbackend-pico`](file:///home/omakoto/cbin/src/raspberry-pi-pico/circuitpython/nsbackend-pico) | Nintendo Switch USB Controller backend over TCP/mDNS for [`raspberry-switch-control`](https://github.com/omakoto/raspberry-switch-control), accepting streamed commands from `nsfrontend` ([`nsbackend-pico.py`](file:///home/omakoto/cbin/src/raspberry-pi-pico/circuitpython/nsbackend-pico/nsbackend-pico.py)). |
