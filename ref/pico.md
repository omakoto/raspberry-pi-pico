...
```text
                                           [ Micro-USB ]
                                        +-------------------+
   GP0 / UART0 TX / I2C0 SDA / SPI0 RX -| [1]          [40] |- VBUS  (5V USB Input)
   GP1 / UART0 RX / I2C0 SCL / SPI0 CS -| [2]          [39] |- VSYS  (1.8V-5.5V Main Power)
                                   GND -| [3]          [38] |- GND
             GP2 / I2C1 SDA / SPI0 SCK -| [4]          [37] |- 3V3_EN (Regulator Enable)
              GP3 / I2C1 SCL / SPI0 TX -| [5]          [36] |- 3V3_OUT (3.3V Power Out)
   GP4 / UART1 TX / I2C0 SDA / SPI0 RX -| [6]          [35] |- ADC_VREF (ADC Reference)
   GP5 / UART1 RX / I2C0 SCL / SPI0 CS -| [7]   PICO   [34] |- GP28 / ADC2
                                   GND -| [8]  FAMILY  [33] |- AGND (ADC Ground Reference)
             GP6 / I2C1 SDA / SPI0 SCK -| [9]          [32] |- GP27 / ADC1 / I2C1 SCL / SPI1 TX
              GP7 / I2C1 SCL / SPI0 TX -| [10]         [31] |- GP26 / ADC0 / I2C1 SDA / SPI1 SCK
   GP8 / UART1 TX / I2C0 SDA / SPI1 RX -| [11]         [30] |- RUN (Hardware Reset / Enable)
   GP9 / UART1 RX / I2C0 SCL / SPI1 CS -| [12]         [29] |- GP22 / I2C1 SDA / SPI0 SCK
                                   GND -| [13]         [28] |- GND
            GP10 / I2C1 SDA / SPI1 SCK -| [14]         [27] |- GP21 / I2C0 SCL
             GP11 / I2C1 SCL / SPI1 TX -| [15]         [26] |- GP20 / I2C0 SDA
  GP12 / UART0 TX / I2C0 SDA / SPI1 RX -| [16]         [25] |- GP19 / I2C1 SCL / SPI0 TX
  GP13 / UART0 RX / I2C0 SCL / SPI1 CS -| [17]         [24] |- GP18 / I2C1 SDA / SPI0 SCK
                                   GND -| [18]         [23] |- GND
            GP14 / I2C1 SDA / SPI1 SCK -| [19]         [22] |- GP17 / UART0 RX / I2C0 SCL / SPI0 CS
             GP15 / I2C1 SCL / SPI1 TX -| [20]         [21] |- GP16 / UART0 TX / I2C0 SDA / SPI0 RX
                                        +-------------------+
                                                | | |
                                         [ SWD Debug Port ]*
...
| Pin # | Silk Pin Name | Default Function | Primary & Alternate Functions (UART / I2C / SPI / ADC / PWM) |
| :---: | :---: | :---: | :--- |
...
| **4** | **GP2** | Digital GPIO | **I2C1 SDA**, **SPI0 SCK**, PWM1 A *(UART0 CTS)* |
| **5** | **GP3** | Digital GPIO | **I2C1 SCL**, **SPI0 TX**, PWM1 B *(UART0 RTS)* |
| **6** | **GP4** | Digital GPIO | **UART1 TX**, **I2C0 SDA**, **SPI0 RX**, PWM2 A |
| **7** | **GP5** | Digital GPIO | **UART1 RX**, **I2C0 SCL**, **SPI0 CS**, PWM2 B |
| **8** | **GND** | Ground | Common Ground |
| **9** | **GP6** | Digital GPIO | **I2C1 SDA**, **SPI0 SCK**, PWM3 A *(UART1 CTS)* |
| **10**| **GP7** | Digital GPIO | **I2C1 SCL**, **SPI0 TX**, PWM3 B *(UART1 RTS)* |
| **11**| **GP8** | Digital GPIO | **UART1 TX**, **I2C0 SDA**, **SPI1 RX**, PWM4 A |
| **12**| **GP9** | Digital GPIO | **UART1 RX**, **I2C0 SCL**, **SPI1 CS**, PWM4 B |
| **13**| **GND** | Ground | Common Ground |
| **14**| **GP10**| Digital GPIO | **I2C1 SDA**, **SPI1 SCK**, PWM5 A *(UART1 CTS)* |
| **15**| **GP11**| Digital GPIO | **I2C1 SCL**, **SPI1 TX**, PWM5 B *(UART1 RTS)* |
...
| **19**| **GP14**| Digital GPIO | **I2C1 SDA**, **SPI1 SCK**, PWM7 A *(UART0 CTS)* |
| **20**| **GP15**| Digital GPIO | **I2C1 SCL**, **SPI1 TX**, PWM7 B *(UART0 RTS)* |
| **21**| **GP16**| Digital GPIO | **UART0 TX**, **I2C0 SDA**, **SPI0 RX**, PWM0 A |
| **22**| **GP17**| Digital GPIO | **UART0 RX**, **I2C0 SCL**, **SPI0 CS**, PWM0 B |
| **23**| **GND** | Ground | Common Ground |
| **24**| **GP18**| Digital GPIO | **I2C1 SDA**, **SPI0 SCK**, PWM1 A *(UART0 CTS)* |
| **25**| **GP19**| Digital GPIO | **I2C1 SCL**, **SPI0 TX**, PWM1 B *(UART0 RTS)* |
| **26**| **GP20**| Digital GPIO | **UART1 TX**, **I2C0 SDA**, **SPI0 RX**, PWM2 A |
| **27**| **GP21**| Digital GPIO | **UART1 RX**, **I2C0 SCL**, **SPI0 CS**, PWM2 B |
| **28**| **GND** | Ground | Common Ground |
| **29**| **GP22**| Digital GPIO | **I2C1 SDA**, **SPI0 SCK**, PWM3 A *(UART1 CTS)* |
| **30**| **RUN** | Reset | Active LOW hardware reset (pull to GND to restart) |
| **31**| **GP26**| ADC0 / GPIO | **ADC Channel 0**, **I2C1 SDA**, **SPI1 SCK**, PWM5 A *(UART1 CTS)* |
| **32**| **GP27**| ADC1 / GPIO | **ADC Channel 1**, **I2C1 SCL**, **SPI1 TX**, PWM5 B *(UART1 RTS)* |
| **33**| **AGND**| Analog Ground | Low-noise ground reference for ADC |
| **34**| **GP28**| ADC2 / GPIO | **ADC Channel 2**, **UART0 TX**, **I2C0 SDA**, **SPI1 RX**, PWM6 A |
