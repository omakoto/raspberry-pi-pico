/*
 * Status LED Controller for nsbackend-pico.
 * Drives onboard LED with state-machine blinking patterns.
 */
...
class StatusLed {
public:
    explicit StatusLed(uint32_t pin = 25, bool active_low = false);
    ~StatusLed();
